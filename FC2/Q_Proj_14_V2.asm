...
gbl_FCV_BLINK_COUNT              EQU	0x00000046 ; bytes:1
gbl_FCV_BTN_SHIFT                EQU	0x00000047 ; bit:0
gbl_FCV_BTN_HOME                 EQU	0x00000047 ; bit:1
gbl_FCV_TOGGLE_SHOTCLOCK         EQU	0x00000047 ; bit:2
gbl_FCV_SCAN1                    EQU	0x00000048 ; bytes:1
gbl_FCV_BTN_SHOTCLOCK            EQU	0x00000049 ; bytes:1
gbl_FCV_SCAN2                    EQU	0x0000004A ; bytes:1
gbl_FCV_DAT                      EQU	0x00000047 ; bit:3
gbl_FCV_FLAG_TOG_BUZZ            EQU	0x00000047 ; bit:4
gbl_FCV_TOGGLE_GUEST             EQU	0x00000047 ; bit:5
...
gbl_FCV_TOGGLE_STARTSTOP         EQU	0x00000047 ; bit:6
gbl_FCV_DISPLAY_SEVENSEG         EQU	0x0000004E ; bytes:1
gbl_FCV_NEW_GAME                 EQU	0x00000047 ; bit:7
gbl_FCV_TOGGLE_HOME              EQU	0x0000004F ; bit:0
gbl_FCV_SHIFTING                 EQU	0x0000004F ; bit:1
gbl_FCV_SWITCH4                  EQU	0x0000004F ; bit:2
gbl_FCV_BTN_STARTSTOP            EQU	0x0000004F ; bit:3
gbl_FCV_GUESTSCORE               EQU	0x00000050 ; bytes:1
gbl_FCV_SWITCH5                  EQU	0x0000004F ; bit:4
gbl_FCV_FLAG_BUZZER              EQU	0x0000004F ; bit:5
gbl_FCV_BUTTON_SCAN              EQU	0x00000051 ; bytes:1
gbl_FCV_HOMESCORE                EQU	0x00000052 ; bytes:1
gbl_FCV_BTN_GUEST                EQU	0x0000004F ; bit:6
gbl_FCV_TEMP_VAR                 EQU	0x00000053 ; bytes:1
gbl_FCV_GAMETIME_MILLIS          EQU	0x00000054 ; bytes:1
gbl_FCV_WINNER_AVAILABLE         EQU	0x0000004F ; bit:7
...
gbl_FCV_TO_SET                   EQU	0x00000057 ; bytes:1
gbl_FCV_TODISPLAY_SS             EQU	0x00000058 ; bytes:1
gbl_FCV_TEMP_SCAN1               EQU	0x00000059 ; bytes:1
gbl_FCV_FLAG_SETTIME             EQU	0x00000056 ; bit:1
gbl_FCV_TEMP_SCAN2               EQU	0x0000005A ; bytes:1
gbl_FCV_BTN_BUZZER               EQU	0x00000056 ; bit:2
gbl_FCV_WINNER                   EQU	0x00000056 ; bit:3
...
; { FCM_TIMEKEEP ; function begin
	BCF STATUS, RP0
	BCF STATUS, RP1
	BTFSS gbl_FCV_FLAG_BUZZER,5
	GOTO	label18
	BSF gbl_FCV_FLAG_TOG_BUZZ,4
...
; { FCM_btn_scan3 ; function begin
	...
	BCF gbl_FCV_SWITCH4,2
	MOVF CompTempVar2206, W
	BTFSS STATUS,Z
	BSF gbl_FCV_SWITCH4,2
	MOVLW 0x02
	BSF STATUS, RP0
	IORWF gbl_trisa, W
	MOVWF gbl_trisa
	...
	BTFSC gbl_FCV_SWITCH4,2
	GOTO	label52
	BSF gbl_FCV_BTN_HOME,1
	RETURN
label52
	BCF gbl_FCV_BTN_HOME,1
	BCF gbl_FCV_TOGGLE_HOME,0
...
; { FCM_btn_scan2 ; function begin
	...
	BTFSC gbl_FCV_SWITCH4,2
	GOTO	label54
	BSF gbl_FCV_BTN_STARTSTOP,3
	RETURN
label54
	BCF gbl_FCV_BTN_STARTSTOP,3
	BCF gbl_FCV_TOGGLE_STARTSTOP,6
	BTFSC gbl_FCV_SWITCH5,4
	GOTO	label55
...
label58
	...
	BTFSC gbl_FCV_BTN_STARTSTOP,3
	INCF CompTempVar2304, F
	CLRF CompTempVar2303
	BTFSS gbl_FCV_TOGGLE_STARTSTOP,6
...
label69
	...
	MOVWF gbl_FCV_PERIOD
label70
	BSF gbl_FCV_TOGGLE_STARTSTOP,6
	RETURN
...
; { FCM_VARIABLE_RESET ; function begin
	...
	BCF gbl_FCV_WINNER,3
	BCF gbl_FCV_WINNER_AVAILABLE,7
	BCF gbl_FCV_NEW_GAME,7
	BCF gbl_FCV_FLAG_STARTSTOP,0
	BCF gbl_FCV_FLAG_BUZZER,5
	BCF gbl_FCV_FLAG_SETTIME,1
	BCF gbl_FCV_FLAG_TOG_BUZZ,4
...
; { FCM_DISPLAY_BLINKING ; function begin
	BCF STATUS, RP0
	BCF STATUS, RP1
	BTFSS gbl_FCV_WINNER_AVAILABLE,7
	GOTO	label98
	MOVLW 0x08
	MOVWF gbl_FCV_TO_SET
label98
